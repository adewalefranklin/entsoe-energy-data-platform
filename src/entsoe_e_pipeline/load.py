...
class S3Loader:
    def __init__(self, aws_access_key_id, aws_secret_access_key, bucket_name, region_name, prefix):
    ...
    def s3_uploader(self, data, key):
        self.logger.info(f"Uploading data to S3 bucket: {self.bucket_name} with key: {key}")
        try:
